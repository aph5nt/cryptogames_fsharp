...
let website = "/CryptoGames"

let githubLink = "http://github.com/Update GitHome in build.fsx/CryptoGames"

// Specify more information about your project
let info =
  [ "project-name", "CryptoGames"
    "project-author", "aph5nt"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/CryptoGames" ]
